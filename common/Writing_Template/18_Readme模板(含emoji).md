...
> 4.**字体控制**：建议使用 14 号字体，略小于正文，以在有限空间内承载更多信息，避免过度占用页面篇幅，影响主体内容阅读；   
...
<div align="center">
  <h4>▶️ 核心能力快速演示</h4>
  <img src="./docs/zh/figures/demo.gif" alt="快速演示" width="600">
  <p><sup>图示：捕获内存越界、未初始化及数据竞争异常的过程演示</sup></p>
</div>

> [!CAUTION] 注意：此引用块内容只用于指导资料开发，请勿纳入正式文档 
> **【简介】段落规范：**   
> 1.**长度控制**：应尽量简短，避免长篇叙述；本段旨在让用户在数秒内快速把握核心能力，并激发进一步了解的兴趣；   
> 2.**架构图片**：若工具逻辑较复杂，可添加一张高度适中的架构示意图，建议采用 SVG 格式，便于后续维护与修改；  
> 3.**动态图片**：为了快速展示核心功能运，可添加一张动态gif图片，格式如上《核心能力快速演示》所示，图示部分按需修改，其它文字不要动；  
> 4.**图片数量**：建议简介中只放一个图片，主仓放架构图展示多子仓的关系，子仓放动态功能演示图展示具体工具功能；  
...
> [!CAUTION] 注意：此引用块内容只用于指导资料开发，请勿纳入正式文档
> **【功能介绍】段落规范：**   
> 1.**长度控制**：应尽量简短，避免长篇叙述；本段旨在让用户快速了解各项主要能力，并激发进一步使用的兴趣；  
