...
> [!NOTE]
>
> 绑核优化的详细介绍请参考《PyTorch 框架特性指南》中的“[自动绑核](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-7.3.0/docs/zh/framework_feature_guide_pytorch/automatic_core_binding.md)”章节。
