    ...
    - **1节点性能问题的原因（从上至下，重要性递减）**
        ...
        2. 模型原本就存在严重的快慢卡问题，syncbn的大量同步导致了大量同步等待时延。
           ...
           **图 1** Elapse Time示意图
           ...
           <img src="./figures/petr_multinode_perf_deg_analysis_fig_01.png" height="107.0517" width="469.49">
    ...
    - **快慢卡原因分析**
        ...
        2. Python侧存在部分函数耗时异常，如图2所示，与之前某些用户存在的现象类似，疑似CPU资源被抢占。
           ...
           **图 2** 慢卡profiling示意图
           ...
           <img src="figures/petr_multinode_perf_deg_analysis_fig_02.png" height="431.0264" width="469.49">
