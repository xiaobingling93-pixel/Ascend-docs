...
1. 请参见《[CANN 快速安装](https://www.hiascend.com/cann/download)》，安装昇腾NPU驱动和CANN软件（包含Toolkit、ops和NNAL包）；请参见《[Ascend Extension for PyTorch 软件安装指南](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.0.0/docs/zh/installation_guide/installation_description.md)》手册，安装PyTorch框架、torch\_npu插件以及APEX模块（可选）。
