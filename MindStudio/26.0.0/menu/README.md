...
- [安装升级与卸载](https://gitcode.com/Ascend/mstt/blob/master/docs/zh/mstt_install_guide.md)
...
- [安装升级与卸载](https://gitcode.com/Ascend/msit/blob/master/docs/zh/msit_install_guide.md)
